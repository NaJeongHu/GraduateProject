...
public class Q4Fragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        q_back.setBackgroundResource(R.drawable.q_4);
        ...
        text_question.setText(getString(R.string.q4));
        ...
        text_answer_3.setText(getString(R.string.q4_3));
        text_answer_4.setText(getString(R.string.q4_4));
