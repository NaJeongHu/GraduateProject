...
public class Q8Fragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        q_back.setBackgroundResource(R.drawable.q_8);
        ...
        circle_indicator_3.setImageResource(R.drawable.q_circle_white);
        circle_indicator_4.setImageResource(R.drawable.q_circle_white);
        circle_indicator_5.setImageResource(R.drawable.q_circle_white);
        circle_indicator_6.setImageResource(R.drawable.q_circle_white);
        circle_indicator_7.setImageResource(R.drawable.q_circle_white);
        circle_indicator_8.setImageResource(R.drawable.q_circle_white);

        text_question = view.findViewById(R.id.text_question);
        text_question.setText(getString(R.string.q8));
        ...
        text_answer_1.setText(getString(R.string.q8_1));
        text_answer_2.setText(getString(R.string.q8_2));
        text_answer_3.setText(getString(R.string.q8_3));
        text_answer_4.setText(getString(R.string.q8_4));
