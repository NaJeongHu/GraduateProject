...
public class Q1Fragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        q_back.setBackgroundResource(R.drawable.q_1);
        ...
        text_question.setText(getString(R.string.q1));
        ...
        text_answer_1.setText(getString(R.string.q1_1));
        text_answer_2.setText(getString(R.string.q1_2));
        text_answer_3.setText(getString(R.string.q1_3));
        text_answer_4.setText(getString(R.string.q1_4));
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.answer_1:
                ...
                ((QuestionActivity)getActivity()).FragmentView(2);
                break;
