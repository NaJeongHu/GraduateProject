...
public class Q3Fragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        q_back.setBackgroundResource(R.drawable.q_3);
        ...
        text_question.setText(getString(R.string.q3));
        ...
        text_answer_3.setText(getString(R.string.q3_3));
        text_answer_4.setText(getString(R.string.q3_4));
