...
public class Q7Fragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        q_back.setBackgroundResource(R.drawable.q_7);
        ...
        text_question.setText(getString(R.string.q7));
        ...
        text_answer_1.setText(getString(R.string.q7_1));
        text_answer_2.setText(getString(R.string.q7_2));
        text_answer_3.setText(getString(R.string.q7_3));
        text_answer_4.setText(getString(R.string.q7_4));
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.answer_1:
                ...
                ((QuestionActivity)getActivity()).FragmentView(8);
                break;
